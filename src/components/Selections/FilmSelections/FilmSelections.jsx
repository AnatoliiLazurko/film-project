    ...
    return (
        <>
            {repetitions.map((_, index) => (
                <NavLink to={'/selection/films/top_action_movies/1'} className={styles["selection-card"]} key={index}>
                    ...
                    <p className={styles["selection-name"]}>Top action movies</p>
                </NavLink>
            ))}
        </>
    );

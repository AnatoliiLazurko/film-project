...
const CartoonSelections = () => {
    return (
        <>
            <NavLink to={'/selection/cartoons/top_action_cartoons/1'} className={styles["selection-card"]}>
                ...
                <p className={styles["selection-name"]}>Top action cartoons</p>
            </NavLink>
        </>
    );
}
